 ...
 * @root: This is a pointer to the root node of the BST to search.
 *
 ...
 * @root: This is a pointer to the root node of the BST.
 * @node: This is a pointer to the node to delete from the BST.
 *
 * Return: This is a pointer to the new root node after deletion.
 */
bst_t *bst_delete(bst_t *root, bst_t *node)
{
