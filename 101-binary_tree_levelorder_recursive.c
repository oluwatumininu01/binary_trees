 ...
 * @tree: This pointer to the root node of the tree to traverse.
 * @func: This pointer to a function to call for each node.
 */
 ...
 * @head: This pointer to head of linked list with nodes at one level.
 * @func: This pointer to a function to call for each node.
 */
void levels_rec(ll *head, void (*func)(int))
{
